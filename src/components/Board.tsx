...
const members: Member[] = [
  {
    ...
    bio: "Prof Rajat Moona leads IITGN CDF as its Chairman while serving as Director, IIT Gandhinagar. He has a long track record in computing and institutional leadership, overseeing initiatives that bridge academia, industry collaboration, and national-level technology programs.",
